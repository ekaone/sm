...
const DaftarPekerjaan = React.lazy(() =>
  import("./views/procurement/home/DaftarPekerjaan")
);
const InformasiPekerjaan = React.lazy(() =>
  import("./views/procurement/home/InformasiPekerjaan")
);
const InputPenawaran = React.lazy(() =>
  import("./views/procurement/home/InputPenawaran")
);
...
const routes = [
  ...
  { path: "/procurement", name: "Procurement", element: DaftarPekerjaan },
  {
    path: "/procurement/daftarpekerjaan",
    name: "Daftar Pekerjaan",
    element: DaftarPekerjaan,
  },
  {
    path: "/procurement/informasipekerjaan",
    name: "Informasi Details Pekerjaan",
    element: InformasiPekerjaan,
  },
  {
    path: "/procurement/inputpenawaran",
    name: "Input Penawaran",
    element: InputPenawaran,
  },
